		...
		try {
			...
			if (doc != null) {
				...
				for (Element e : doc.select("li")) {
					if ((e.text().contains("Rating:"))&&(e.text().contains(" Rating: ")==false))System.out.println(e.text());
					if (e.text().contains("Genre:"))System.out.println(e.text());	
					if (e.text().contains("Original Language:"))System.out.println(e.text());
					if (e.text().contains("Director:"))System.out.println(e.text());
					if (e.text().contains("Producer:"))System.out.println(e.text());
					if (e.text().contains("Writer:"))System.out.println(e.text());
					if (e.text().contains("Release Date (Theaters):"))System.out.println(e.text());
					if (e.text().contains("Runtime:"))System.out.println(e.text());
					if (e.text().contains("Production Co:"))System.out.println(e.text());
				...
				*/
				...
				for (Element e : doc.select("div.media-body")) {
					...
					if (l.length<=5)System.out.println(l[0]+" "+l[1]);
				}
